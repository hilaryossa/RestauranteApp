...
|---|---|---|
| Integrante 1 | Líder técnico | Emily Quintero Rivera |
| Integrante 2 | Desarrollo GUI | Hilary David Ossa |
| Integrante 3 | Documentación y pruebas | Sofia Hidalgo Córdoba |
...
![Pantalla principal](docs/imgs/pantalla-principal.png)

![gestionar clientes](docs/imgs/gestionar-clientes.png)

![menu restaurante](docs/imgs/menu-restaurante.png)

![gestionar reservas](docs/imgs/gestionar-reservas.png)

![mesas restaurante](docs/imgs/mesas-restaurante.png)
